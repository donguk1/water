...
function displayPlaces(places) {
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        var placePosition = new kakao.maps.LatLng(places[i].y, places[i].x),
            marker = addMarkerSearch(placePosition, i),
...
function addMarkerSearch(position, idx, title) {
...
function displayPlacesCategory(places) {
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        // 마커를 생성하고 지도에 표시합니다
        var marker = addMarkerCategory(new kakao.maps.LatLng(places[i].y, places[i].x), order);
...
function geolocationMarker(locPosition, message) {
